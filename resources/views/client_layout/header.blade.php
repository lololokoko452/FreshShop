                ...
                <ul class="cart-list">
                    @if(Session::has('topCart'))
                        @foreach(Session::get('topCart') as $item)
                            <li>
                                <a href="#" class="photo"><img src="{{ asset('storage/product_images/' . $item['product_image']) }}" class="cart-thumb" alt="" /></a>
                                <h6><a href="#">{{ $item['product_name'] }}</a></h6>
                                <p>{{ $item["qty"] }}x - <span class="price">${{ $item['product_price'] }}</span></p>
                            </li>
                        @endforeach
                    @endif
                    ...
                    <li class="total">
                        ...
                        <span class="float-right"><strong>Total</strong>: ${{ Session::has('cart') ? number_format(Session::get('cart'), 1) : 0 }}</span>
                    </li>
                </ul>
            </li>
        </div>
